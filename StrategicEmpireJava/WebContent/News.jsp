            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Un nuovo gioco di avventure epiche con componenti di alta qualit� e storie coinvolgenti.</p>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Combatti epiche battaglie spaziali con flotte di astronavi personalizzabili. Vivi l'epicit� del conflitto intergalattico.</p>
                        <a href="#" class="btn btn-primary w-100 mt-auto">Leggi di pi�</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Sunrise Lane, adatto a tutta la famiglia. Accaparratevi i terreni pi� prestigiosi e costruite splendide case per ottenere la vittoria!</p>
                        <a href="#" class="btn btn-primary w-100 mt-auto">Leggi di pi�</a>
                    </div>
                </div>
            </div>
