	...
	<div class="invoice-container">
		<div class="invoice-header">
			<div>
				...
				<p>
					<strong>Data:</strong>
					<%= ordine != null ? ordine.getData() : "N/A" %></p>
				<p>
					<strong>Numero Fattura:</strong>
					<%= ordine != null ? ordine.getCodOrdine() : "N/A" %></p>
			</div>
		...
		<div class="invoice-details">
			<div class="row">
				<div class="col-sm-6">
					<h5>Mittente</h5>
					<p>
						<strong>StrategicEmpire S.R.L.</strong>
					</p>
				...
				<div class="col-sm-6">
					<h5>Destinatario</h5>
					<p>
						<strong><%= ordine != null ? ordine.getCodiceUtente() : "N/A" %></strong>
					</p>
					<p id="nome">
						Nome:
						<%=u.getNome() %></p>
					...
					<p id="recipientAddress">Indirizzo: <%=u.getIndirizzo() %></p>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<!-- Sostituisci con la descrizione reale se disponibile -->
		...
		<div class="quantity-summary">
			...
			<p>
				...
				<%= ordine != null ? quantitaTotale : "N/A" %></p>
			<p>
				<strong>Totale Fattura:</strong>
				<%= ordine != null ? String.format("%.2f", totalePrezzo+10) : "N/A" %>
				EUR
			</p>
			<p>
		...
		<div class="no-print btn-print">
			<button class="btn btn-primary" onclick="window.print()">Stampa
				/ Scarica</button>
		</div>
	</div>
</body>
