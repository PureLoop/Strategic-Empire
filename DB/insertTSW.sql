...
insert into espansione(cod_espansione,nome_espansione,descrizione,cod_gioco) values("esp001","Barrage 5 giocatore","Arricchisci la tua copia di Barrage con una nuova mappa progettata specificamente per 5 giocatori e scopri le nuove connessioni, studiate per consentire nuove strategie di piazzamento senza alterare il flusso di gioco.","g001");
insert into img_gioco(cod_img_gioco,img) values ("g001Img1",load_file("C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\pogettoTSW\\IMMAGINI_CATALOGO\\IMMAGINI_GIOCHI\\Barrage_BOX-3D.png")),
...
insert into img_acc(cod_img_acc,img) values("acc01Img1",load_file("C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\pogettoTSW\\IMMAGINI_CATALOGO\\IMMAGINI_ACCESSORI\DADI_ROSSI1.jpg"))
...
insert into img_esp(cod_img_esp,img) values("esp001Img1",load_file("C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\pogettoTSW\\IMMAGINI_CATALOGO\\IMMAGINI_ESPANSIONI\\Barrage_5Th-Giocatore_scatola.png")),
