...
Riuscirete a sviluppare al meglio le storiche autostrade della Germania e a dare il maggior contributo all'Autobahn?",1,4),
...
La grande novità è che sarà uno smartphone a fare da master e garantire longevità al gioco!",2,4),
...
Con una grande varietà di elementi di gioco, come le fazioni con abilità uniche, il setup casuale delle azioni sulla stella e un bassissimo impatto della fortuna,  Anunnaki - L’Alba degli Dèi rappresenta un’esperienza incredibilmente immersiva e profonda.",1,4),
...
possibile. Giocate le carte al momento giusto oppure pagate il prezzo dei vostri errori! Ma state attenti: ogni personaggio potrà cambiare la partita con le sue singolari abilità! Dopo tutto, che gioco sarebbe senza incredibili colpi di scena?",2,6),
...
La semplicità delle regole di Taboo è uno dei suoi punti di forza. È facile da imparare e si può iniziare a giocare in pochissimi minuti. Il fatto che non siano necessari lunghi tempi di spiegazione lo rende perfetto per tutti i tipi di giocatori, dai bambini agli adulti.",4,10),
